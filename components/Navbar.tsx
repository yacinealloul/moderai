...
<nav className='sticky h-14 inset-x-0 top-0 z-30 w-full border-b border-gray-500 bg-white/75 backdrop-blur-lg transition-all'>
  ...
  <rect x="32.0348" y="37" width="20" height="20" rx="5" fill="#E0E0E0"/>
  <rect x="45" y="70" width="25" height="20" rx="5" fill="#E0E0E0"/>
  <rect x="65.0348" y="37" width="20" height="20" rx="5" fill="#E0E0E0"/>
</svg>
