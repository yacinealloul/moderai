...
<div className="min-h-screen bg-gray-100 text-gray-900 antialiased">
    ...
    <section className="relative pt-20 pb-32 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl z-10">
            Learn how <span className="text-blue-600">flagged.ai</span> can transform your approach to text processing.
        </h1>
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg z-10">
            Submit your text to our API endpoint, and let our system do its magic. Our model system analyzes text content in real-time and delivers detailed results within milliseconds.
        </p>
    ...
    <div className="container mx-auto px-4">
      <div className="mb-12 px-6 lg:px-8 text-center">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Cutting-edge features that make your text processing smart and efficient.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        <div className="p-6 bg-white rounded-lg shadow-lg">
          ...
          <p className="text-gray-600">Analyze texts on-the-fly without any delay, enhancing user experience and efficiency.</p>
        </div>
